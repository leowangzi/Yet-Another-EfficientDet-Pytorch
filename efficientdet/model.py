...
class BiFPN_infer(nn.Module):
    ...
    def __init__(self, num_channels, conv_channels, first_time=False, index=0, epsilon=1e-4, onnx_export=False, attention=True, image_size=None):
        ...
        self.weight_p6_1.append([self.hex2float("0x3eab6ee5"), self.hex2float("0x3f2a4523")])
        self.weight_p5_1.append([self.hex2float("0x3f14779f"), self.hex2float("0x3ed70b55")])
        self.weight_p4_1.append([self.hex2float("0x3ef524e9"), self.hex2float("0x3f056b58")])
        self.weight_p3_1.append([self.hex2float("0x3ef7e118"), self.hex2float("0x3f040d56")])
        self.weight_p3_2.append([self.hex2float("0x3ee0c8e4"), self.hex2float("0x3f0f993f"), self.hex2float("0x0")])
        self.weight_p4_2.append([self.hex2float("0x3f4fca29"), self.hex2float("0x3e40cbfb"), self.hex2float("0x0")])
        self.weight_p5_2.append([self.hex2float("0x3f6cac7c"), self.hex2float("0x0"), self.hex2float("0x3d9a81b9")])
        self.weight_p6_2.append([self.hex2float("0x3f357c1b"), self.hex2float("0x3e950244")])
        
        self.weight_p6_1.append([self.hex2float("0x3bcc2445"), self.hex2float("0x3f7e633d")])
        self.weight_p5_1.append([self.hex2float("0x3efcd99c"), self.hex2float("0x3f019012")])
        self.weight_p4_1.append([self.hex2float("0x3f06756d"), self.hex2float("0x3ef30f7d")])
        self.weight_p3_1.append([self.hex2float("0x3f17fb4e"), self.hex2float("0x3ed0048f")])
        self.weight_p3_2.append([self.hex2float("0x3ec6de32"), self.hex2float("0x3ea4b5c7"), self.hex2float("0x3e946852")])
        self.weight_p4_2.append([self.hex2float("0x3f217ef3"), self.hex2float("0x3ebcfcfb"), self.hex2float("0x0")])
        self.weight_p5_2.append([self.hex2float("0x3ee7e5ae"), self.hex2float("0x3c0798cb"), self.hex2float("0x3f09ec48")])
        self.weight_p6_2.append([self.hex2float("0x3f55fd4b"), self.hex2float("0x3e27ff8f")])
        
        self.weight_p6_1.append([self.hex2float("0x3e13f37d"), self.hex2float("0x3f5aff9d")])
        self.weight_p5_1.append([self.hex2float("0x3f19699b"), self.hex2float("0x3ecd2649")])
        self.weight_p4_1.append([self.hex2float("0x3f41c6a7"), self.hex2float("0x3e78d845")])
        self.weight_p3_1.append([self.hex2float("0x3f33de7d"), self.hex2float("0x3e983d5a")])
        self.weight_p3_2.append([self.hex2float("0x3ead4954"), self.hex2float("0x3ed7d342"), self.hex2float("0x3e75bf10")])
        self.weight_p4_2.append([self.hex2float("0x3f3f91d6"), self.hex2float("0x3e80d6ec"), self.hex2float("0x0")])
        self.weight_p5_2.append([self.hex2float("0x3e562e4d"), self.hex2float("0x3edfb316"), self.hex2float("0x3eb531dd")])
        self.weight_p6_2.append([self.hex2float("0x3f068218"), self.hex2float("0x3ef2f739")])
        
        self.weight_p6_1.append([self.hex2float("0x0"), self.hex2float("0x3f7ffbcc")])
        self.weight_p5_1.append([self.hex2float("0x3f6d9c05"), self.hex2float("0x3d92ff9e")])
        self.weight_p4_1.append([self.hex2float("0x3f46a596"), self.hex2float("0x3e655cca")])
        self.weight_p3_1.append([self.hex2float("0x3f30125d"), self.hex2float("0x3e9fd5e3")])
        self.weight_p3_2.append([self.hex2float("0x3ece834b"), self.hex2float("0x3ede5b41"), self.hex2float("0x3e263acb")])
        self.weight_p4_2.append([self.hex2float("0x3efb501c"), self.hex2float("0x0"), self.hex2float("0x3f0255a3")])
        self.weight_p5_2.append([self.hex2float("0x0"), self.hex2float("0x3eb47fa5"), self.hex2float("0x3f25be0e")])
        self.weight_p6_2.append([self.hex2float("0x3f01abe3"), self.hex2float("0x3efca410")])
        
        self.weight_p6_1.append([self.hex2float("0x3f01ec75"), self.hex2float("0x3efc2148")])
        self.weight_p5_1.append([self.hex2float("0x3f0cca0b"), self.hex2float("0x3ee66640")])
        self.weight_p4_1.append([self.hex2float("0x3ef1033c"), self.hex2float("0x3f077b40")])
        self.weight_p3_1.append([self.hex2float("0x3f3add83"), self.hex2float("0x3e8a3f9a")])
        self.weight_p3_2.append([self.hex2float("0x3e7c1938"), self.hex2float("0x3ef50260"), self.hex2float("0x3e8ced2e")])
        self.weight_p4_2.append([self.hex2float("0x3eb81c08"), self.hex2float("0x3de52b77"), self.hex2float("0x3f074a6b")])
        self.weight_p5_2.append([self.hex2float("0x0"), self.hex2float("0x3ec01182"), self.hex2float("0x3f1ff4f2")])
        self.weight_p6_2.append([self.hex2float("0x3ee6de5b"), self.hex2float("0x3f0c8f6e")])
